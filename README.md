...
It's used as a demo application to run static code analysis, software composition analscscysis and dynamic API scanning. There will be findings for all differnt type of scanning technologies.  
Static Findings  
